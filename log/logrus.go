//Package logger is based on https://github.com/plutov/echo-logrus
package logger
...
func logrusMiddlewareHandler(c echo.Context, next echo.HandlerFunc) error {
	...
	Logger.WithFields(map[string]interface{}{
		"domain":        "echo", //Add our domain for filtering
...
func logHandler(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		return logrusMiddlewareHandler(c, next)
	}
}

// Middleware is a function to process middleware.
